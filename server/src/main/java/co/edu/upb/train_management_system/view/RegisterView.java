...
import co.edu.upb.train_management_system.view.LoginView;
...
public class RegisterView {
    ...
    private JTextField fieldIdType;
    ...
    public RegisterView() {
        ...
        fieldIdType = addField(fields, "Tipo de identificación");
    ...
    private void handleRegister() {
        ...
        String idType = fieldIdType.getText().trim();
        ...
        if (id.isEmpty() || names.isEmpty() || lastNames.isEmpty()
                || idType.isEmpty() || address.isEmpty() || password.isEmpty()) {
