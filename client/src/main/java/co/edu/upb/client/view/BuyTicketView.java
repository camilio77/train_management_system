...
public class BuyTicketView {
    ...
    private String getAsientoInfo(String cat) {
        return switch (cat) {
            case "PREMIUM" ->
                "Zona Premium: asientos 1-4";
            case "EJECUTIVA" ->
                "Zona Ejecutiva: asientos 5-12";
            default ->
                "Zona Estándar: asientos 13-34";
        };
    }
    ...
    public static class StationMapPanel extends JPanel {
        ...
        public StationMapPanel() {
            ...
            addMouseMotionListener(new MouseMotionAdapter() {
                ...
                public void mouseMoved(MouseEvent e) {
                    ...
                    if (!Objects.equals(prev, hoverIdx)) {
                        repaint();
                    }
                }
            });
        ...
        public void setOnSelectionChanged(SelectionListener l) {
            this.listener = l;
        }
        ...
        private void notify(String origen, String destino) {
            if (listener != null) {
                listener.onChanged(origen, destino);
            }
        }
        ...
        protected void paintComponent(Graphics g) {
            ...
            for (Map.Entry<Integer, Point> e : positions.entrySet()) {
                ...
                Color nodeColor;
                if (Integer.valueOf(idx).equals(selectedOrigenIdx)) {
                    nodeColor = C_ORIGEN; 
                }else if (Integer.valueOf(idx).equals(selectedDestinoIdx)) {
                    nodeColor = C_DESTINO; 
                }else if (Integer.valueOf(idx).equals(hoverIdx)) {
                    nodeColor = C_HOVER; 
                }else if (highlightedPath.contains(stations.get(idx))) {
                    nodeColor = C_EDGE_PATH; 
                }else {
                    nodeColor = C_NODE;
                }
