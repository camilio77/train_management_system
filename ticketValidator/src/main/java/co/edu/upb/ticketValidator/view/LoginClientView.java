...
public class LoginClientView {
    ...
    public LoginClientView() {
        frame = new JFrame("Validador de Tickets — Login");
        ...
        JLabel appTitle = new JLabel("Validador de Tickets", SwingConstants.CENTER);
        appTitle.setFont(new Font("Arial", Font.BOLD, 20));
        appTitle.setForeground(Color.WHITE);
        appTitle.setAlignmentX(Component.CENTER_ALIGNMENT);

        JLabel appSub = new JLabel("Sistema de validación", SwingConstants.CENTER);
